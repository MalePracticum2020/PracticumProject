...
@app.callback(
    [Output('next', 'active_cell'),Output('next', 'selected_cells'),Output('next2', 'selected_cells')],
...
displayApp("ProjectData/new/ecel-export_1599863833/parsed/tshark/networkDataXY.JSON")

...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow, folder_path):
        ...
        self.webEngine.setObjectName("throughput_frame")
        self.verticalLayout_2 = QtWidgets.QVBoxLayout(self.webEngine)
        self.verticalLayout_2.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_2.setObjectName("verticalLayout_2")
        self.throughput_label = QtWidgets.QLabel(self.webEngine)
        font = QtGui.QFont()
        ...
        self.throughput_scrollareawidget.setGeometry(
            QtCore.QRect(0, 0, 752, 225))
        self.throughput_scrollareawidget.setObjectName(
            "throughput_scrollareawidget")
        self.gridLayout = QtWidgets.QGridLayout(
            self.throughput_scrollareawidget)
        ...
        self.mouseclicks_frame = QtWidgets.QFrame(
            self.scrollAreaWidgetContents)
        ...
        self.mouseclicks_scrollarea = QtWidgets.QScrollArea(
            self.mouseclicks_frame)
        ...
        self.mouseclicks_scrollareawidget.setGeometry(
            QtCore.QRect(0, 0, 752, 225))
        self.mouseclicks_scrollareawidget.setObjectName(
            "mouseclicks_scrollareawidget")
        self.gridLayout_4 = QtWidgets.QGridLayout(
            self.mouseclicks_scrollareawidget)
        ...
        self.mouseclicks_scrollarea.setWidget(
            self.mouseclicks_scrollareawidget)
        ...
        self.keypresses_scrollarea = QtWidgets.QScrollArea(
            self.keypresses_frame)
        ...
        self.keypresses_scrollareawidget.setGeometry(
            QtCore.QRect(0, 0, 752, 225))
        self.keypresses_scrollareawidget.setObjectName(
            "keypresses_scrollareawidget")
        self.gridLayout_5 = QtWidgets.QGridLayout(
            self.keypresses_scrollareawidget)
        ...
        # Add Example
        self.createDataLinesDisplayBoxes("", 0, "TimedScreenshots")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.mouseclicks_label.setText(
            _translate("MainWindow", "Mouse Clicks"))
    ...
    def createDataLinesDisplayBoxes(self, address, itemIndex, type):
        ...
        if type == "Auditd":
            ...
            tablewidget.setObjectName("auditd_tablewidgetxx" + str(itemIndex))
        if type == "MouseClicks":
            tablewidget = self.MouseClicks.getTable()
            tablewidget.setObjectName("auditd_tablewidgetxx" + str(itemIndex))
        if type == "TimedScreenshots":
        ...
        _translate = QtCore.QCoreApplication.translate
        label.setText(_translate("MainWindow", "E X T R A "))
